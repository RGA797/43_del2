...
public class Board {
    ...
    public String getFieldText() {
        final String[] fieldTextList = new String[]{
                ...
                "You enter a fortified city, within the safety of the tall walls you gather supplies and your strength.",
                "You come across a monastery, you're safe but unfortunately there's nothing to gain here.",
                "You take a shortcut through a black cave alas luck is not with you, you get lost.",
